...
import grmasa.com.open_light.yapi.command.YeelightCommand;
import grmasa.com.open_light.yapi.enumeration.YeelightAdjustAction;
import grmasa.com.open_light.yapi.enumeration.YeelightAdjustProperty;
import grmasa.com.open_light.yapi.enumeration.YeelightEffect;
import grmasa.com.open_light.yapi.enumeration.YeelightProperty;
...
import grmasa.com.open_light.yapi.result.YeelightResultError;
import grmasa.com.open_light.yapi.result.YeelightResultOk;
import grmasa.com.open_light.yapi.exception.YeelightSocketException;
import grmasa.com.open_light.yapi.socket.YeelightSocketHolder;
...
import static grmasa.com.open_light.yapi.utils.YeelightUtils.clamp;
import static grmasa.com.open_light.yapi.utils.YeelightUtils.clampAndComputeRGBValue;
...
public class YeelightDevice {
     ...
     */
    private YeelightDevice(String ip, int port, YeelightEffect effect, int duration) throws YeelightSocketException {
    ...
    public String getState() throws YeelightResultErrorException, YeelightSocketException {
        YeelightCommand command = new YeelightCommand("get_prop", "power");
        String[] result = this.sendCommand(command);
        return result[0];
    }

    public String getBrightness() throws YeelightResultErrorException, YeelightSocketException {
    ...
    public void setRGB(int rgb) throws YeelightResultErrorException, YeelightSocketException {
        YeelightCommand command = new YeelightCommand("set_rgb", rgb, this.effect.getValue(), this.duration);
        this.sendCommand(command);
    }
